...
function journeyPlanner(locations, transportMode) {
  ...
  /*first we filter through the array of locations to see if it includes the transport mode required.
  If it does it will return us arrays of locations with the transport mode we want to use*/

  /**Then we use .map() to only get the location names we can go to by location's index which [0] for every array*/
  return locations
